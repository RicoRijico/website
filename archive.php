    ...
    <!-- header -->
        ...
        <header role="header" class="header-top" id="headere-top">
            ...
            <!-- banner Text --> 
                 ...
                 <a class="popup-vimeo video-button" href="https://www.youtube.com/watch?v=HXLviEusCyE"><i class="fa fa-caret-right" aria-hidden="true"> 
                     ...
                     <a  href="<?php echo get_permalink(157); ?>" class="button-header">Get Strated</a>
                </section>
            ...
            <section class="section-one text-center" id="section-one">
                ...
                <div class="container">
                    ...
                    <header role="title-page">
                        ...
                        <h2 style=" padding-left:30px; padding-right: 30px;text-align: justify; text-align: center;"> <?php the_title(); ?></h2>
                    ...
                    <article style="text-align: left;">
                      ...
                      <!-- <?php  while (have_posts()): the_post(); ?>
                      	<div class="teaser-box clearfix">
                      		<div class="teaser_img" style="float:left; margin-right: 20px">
